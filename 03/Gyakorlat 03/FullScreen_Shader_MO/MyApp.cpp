...
void CMyApp::InitShaders()
{
	...
	AssembleProgram( m_programID, "Vert_FullscreenNoBuffer.vert", "Frag_PosCol_Time.frag" );
}
...
void CMyApp::Render()
{
	...
	glUniform1f(glGetUniformLocation(m_programID, "shiftx"), shiftx);
	glUniform1f(glGetUniformLocation(m_programID, "shifty"), shifty);
	glUniform1f(glGetUniformLocation(m_programID, "zoom"), zoom);
	glUniform1i(glGetUniformLocation(m_programID, "iteration"), iteration);
	// !!!!!!!!!!!!
